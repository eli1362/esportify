                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($event['validation_status'] == 'en_attente'): ?>
                                                <a href="validate_event.php?id=<?= $event['id'] ?>&action=valider" class="btn green" style="margin:0">
                                        ...
                                        <td>
                                            <?php if ($event['session_started'] == 0): ?>
                                                <a href="toggle-session.php?id=<?= $event['id'] ?>&status=1" class="btn green" style="margin: 0">
                                        ...
                                        <td>
                                            <a href="get-event-details.php?id=<?= $event['id'] ?>" class="btn green" style="margin: 0">
                                                Voir détails
                                            </a>
                                        </td>
                                    </tr>
